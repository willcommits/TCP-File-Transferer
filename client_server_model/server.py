...
# Deletes the private files in the public files as soon as user logsout
...
# Checks if user has a hidden file or private files if so imports them to the public files so they can see them
